...
[![skills.sh](https://skills.sh/b/weqi-pan/architecture-drawing)](https://skills.sh/weqi-pan/architecture-drawing/architecture-drawing)

技能目录页：<https://skills.sh/weqi-pan/architecture-drawing/architecture-drawing>
...
python -m pip install -r architecture-drawing/requirements.txt
```
